...
const GoogleIcon = () => (
  <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
    ...
    <path
      fill="#1976D2"
      d="M43.6 20.1H42V20H24v8h11.3c-.8 2.2-2.2 4.2-4.1 5.6l6.2 5.2C41.2 34.7 44 29.7 44 24c0-1.3-.1-2.6-.4-3.9z"
    />
  </svg>
)

const GoogleButton = ({ children = 'Continue with Google', onClick, disabled, isLoading }) => (
  <Button
    variant="google"
    className="w-full"
    onClick={onClick}
